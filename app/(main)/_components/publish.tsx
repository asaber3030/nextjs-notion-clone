...
const Publish = ({ initialData }: PublishProps) => {
  ...
  const onPublish = () => {
    ...
    toast.promise(promise, {
      loading: 'Publishing....',
      error: 'Could not publish this note',
      success: 'Done Publishing!'
    })
  }
  const onUnPublish = () => {
    setIsSubmitting(true)
    ...
    toast.promise(promise, {
      ...
      error: 'Could not unpublish this note',
      success: 'Done Unpublishing!'
    })
  }
  ...
  return (
    <Popover>
      ...
      <PopoverContent content='w-72' align='end' alignOffset={8} forceMount>
        {initialData.isPublished ? (
          <div className='space-y-4'>
            <div className='flex items-center gap-x-2'>
              <Globe className='text-sky-500 animate-pulse h-4 w-5' />
          ...
          <div className='flex flex-col items-center justify-center'>
            ...
            />
            <p content='text-sm font-medium mb-2'>
              Publish this note
            </p>
